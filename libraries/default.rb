...
module Opscode
  ...
  module PostgresqlHelpers
    ...
    # Used in recipes/config_initdb.rb to set this attribute:
    #    node.default['rackspace_postgresql']['config']['datestyle']
    ...
    #    node.default['rackspace_postgresql']['config']['log_timezone']
    #    node.default['rackspace_postgresql']['config']['timezone']
    ...
    def pgdgrepo_rpm_info
      repo_rpm_url = node['rackspace_postgresql']['pgdg']['repo_rpm_url']
        .fetch(node['rackspace_postgresql']['version'])            # e.g., fetch for "9.1"
